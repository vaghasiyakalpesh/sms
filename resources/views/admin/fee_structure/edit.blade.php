                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="fee_head" id="fee-head">
                                                    ...
                                                    @foreach ($feeHeads as $feeHead)
                                                        <option value="{{ $feeHead->id }}" {{old('fee_head', $feeStructure->fee_head_id) == $feeHead->id ? 'selected' : '' }}>
                                                            {{$feeHead->name}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="class" id="class-id">
                                                    ...
                                                    @foreach ($classes as $class)
                                                        <option value="{{ $class->id }}" {{ old('class', $feeStructure->class_id) == $class->id ? 'selected' : '' }}>
                                                            {{$class->name}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="academic_year" id="academic-year-id">
                                                    ...
                                                    @foreach ($academicYears as $academicYear)
                                                        <option value="{{ $academicYear->id }}" {{ old('academic_year', $feeStructure->academic_year_id) == $academicYear->id ? 'selected' : ''}}>{{$academicYear->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            @error('academic_year')
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="january" class="form-control" id="january"
                                                    ...
                                                    value="{{ old('january', $feeStructure->january) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="february" class="form-control" id="fee-head"
                                                    ...
                                                    value="{{ old('february', $feeStructure->february) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="march" class="form-control" id="march"
                                                    ...
                                                    value="{{ old('march', $feeStructure->march) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="april" class="form-control" id="april"
                                                    ...
                                                    value="{{ old('april', $feeStructure->april) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="may" class="form-control" id="may"
                                                    ...
                                                    value="{{ old('may', $feeStructure->may) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="june" class="form-control" id="june"
                                                    ...
                                                    value="{{ old('june', $feeStructure->june) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="july" class="form-control" id="july"
                                                    ...
                                                    value="{{ old('july', $feeStructure->july) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="august" class="form-control" id="august"
                                                    ...
                                                    value="{{ old('august', $feeStructure->august) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="september" class="form-control" id="september"
                                                    ...
                                                    value="{{ old('september', $feeStructure->september) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="october" class="form-control" id="october"
                                                    ...
                                                    value="{{ old('october', $feeStructure->october) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="november" class="form-control" id="november"
                                                    ...
                                                    value="{{ old('november', $feeStructure->november) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="december" class="form-control" id="december"
                                                    ...
                                                    value="{{ old('december', $feeStructure->december) }}">
                                            </div>
                                        </div>
                                    </div>
