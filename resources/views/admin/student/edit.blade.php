                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="class" id="class-id">
                                                    ...
                                                    @foreach ($classes as $class)
                                                        <option value="{{ $class->id }}" {{ old('class', $student->class_id) == $class->id ? 'selected' : '' }}>
                                                            {{$class->name}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="academic_year" id="academic-year-id">
                                                    ...
                                                    @foreach ($academicYears as $academicYear)
                                                        <option value="{{ $academicYear->id }}" {{ old('academic_year', $student->academic_year_id) == $academicYear->id ? 'selected' : '' }}>
                                                            {{$academicYear->name}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="admission_date" class="form-control"
                                                    ...
                                                    placeholder="Enter Student Admission Date">
                                            </div>
